    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnaddress.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent Intent = new Intent(NewPostActivity.this, SwitchWalletActivity.class);
    ...
    private void clickEvents() {
        ...
        selectDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                datePickerDialog = new DatePickerDialog(NewPostActivity.this,
                        ...
                        mDatabase.child("users").child(userId).addListenerForSingleValueEvent(
                                new ValueEventListener() {
                                    ...
                                    public void onDataChange(DataSnapshot dataSnapshot) {
                                        ...
                                        Post post = new Post(userId, user.username, title, body, nation, date, pricetext, price+"000000000000000000", address, IMAGE);
