...
import com.example.rhkdg.sharethetrip.contract.SampleContract;
    ...
    private void setContractValue() {
        ...
        Observable.create(e -> {
            ...
            e.onComplete();
                ...
                .subscribe(o -> Toast.makeText(SampleContractActivity.this, "설치 성공", Toast.LENGTH_SHORT).show()
                ...
                Observable.create((ObservableOnSubscribe<SampleContract>) emitter -> {
                    ...
                    emitter.onComplete();
                        ...
                        .subscribe(sampleContract -> {
                            ...
                            Toast.makeText(this, "계약이 추가로 적재되어 완성되다.", Toast.LENGTH_SHORT).show();
                        }, throwable -> throwable.printStackTrace())
                ;
