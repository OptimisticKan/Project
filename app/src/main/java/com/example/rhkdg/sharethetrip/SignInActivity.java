   ...
   /* private EditText mEmailField;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mGoogleApiClient = new GoogleApiClient.Builder(this)
                ...
                .build();
        Google_Login = findViewById(R.id.Google_Loginbtn);
        ...
        LoginButton buttonFacebook = findViewById(R.id.buttonFacebookLogin);
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (!task.isSuccessful()) {
                            ...
                            Intent intent = new Intent(SignInActivity.this, Main3Activity.class);
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            // 로그인 실패
                            Toast.makeText(SignInActivity.this, "페이스북 로그인 인증 성공", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    }
